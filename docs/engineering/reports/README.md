...
| 2026-09-14 | [Phase 0, slice 7: the install and deployment runbook](2026-09-14-phase-0-slice-7-install-runbook.md) | PASS WITH RISKS | Install runbook for XAMPP/Laragon/php -S, fail-closed web-root layout, deny files, a built-in-server router, deployment contract tests, and a corrected claim about rewrite-free URLs |
| 2026-09-14 | [Phase 0, slice 8: the panel-only install and update path](2026-09-14-phase-0-slice-8-web-installer.md) | PASS WITH RISKS | Standalone web installer with a one-time token, CSRF and attempt limiting, self-disabling once installed; token-gated `/maintenance` page for migrations and new default settings |
